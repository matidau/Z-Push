...
#
#   curl -s https://mat.id.au/zpushtesting.sh | sudo bash
#
#########################################################
#
...
if [ "$SCRIPT_ZPUSH_VERSION" == "2.6.2" ]; then
	...
	sed -i "s/VERSION=2.6.2/VERSION=2.6.4-php8-testing-0.3/g" setup/zpush.sh
	sed -i "s/TARGETHASH=f0e8091a8030e5b851f5ba1f9f0e1a05b8762d80/TARGETHASH=5c04ccc3d43ceda3ca42756fc796b6b09b8ffdc0/g" setup/zpush.sh
	...
	# update Z-Push setup script
	sed -i "s/VERSION=2.6.4-php8-testing-0.2/VERSION=2.6.4-php8-testing-0.3/g" setup/zpush.sh
	sed -i "s/TARGETHASH=80ee26707958ee695a86e6ffaf326ee56dce6a14/TARGETHASH=5c04ccc3d43ceda3ca42756fc796b6b09b8ffdc0/g" setup/zpush.sh
	#sed -i "s^https://github.com/Z-Hub/Z-Push/archive/refs/tags/^https://github.com/matidau/Z-Push/archive/refs/tags/^g" setup/zpush.sh
elif [ "$SCRIPT_ZPUSH_VERSION" == "2.6.4-php8-0.2" ]; then
	# update Z-Push setup script
	sed -i "s/VERSION=2.6.4-php8-0.2/VERSION=2.6.4-php8-testing-0.3/g" setup/zpush.sh
	sed -i "s/TARGETHASH=90232303c0326a713932988546fb6274c3313266/TARGETHASH=5c04ccc3d43ceda3ca42756fc796b6b09b8ffdc0/g" setup/zpush.sh
